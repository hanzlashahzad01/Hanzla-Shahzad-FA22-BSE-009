  ...
  void _loadThemePreference() async {
    ...
    setState(() {
      _isDarkMode =
          ...
          false; // Fetch saved preference or default to false
    });
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme:
          _isDarkMode
              ? ThemeData.dark()
              : ThemeData.light(), // Apply theme based on preference
      home: NotesScreen(
        toggleTheme: _toggleTheme,
      ), // Home screen with theme toggle functionality
    );
  }
}
...
class _NotesScreenState extends State<NotesScreen> {
  ...
  TextEditingController _noteController =
      TextEditingController(); // Controller for note input field
  ...
  void _editNote(Map<String, dynamic> note) {
    setState(() {
      ...
      _noteController.text =
          note['content']; // Load note content into text field
    });
  }
                    ...
                    trailing: Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed:
                              () => _editNote(_notes[index]), // Edit note
                        ),
                        IconButton(
